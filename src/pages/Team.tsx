            ...
            <div className="grid grid-cols-1 gap-16 max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div className="text-center space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground font-inter leading-relaxed max-w-md mx-auto">
              ...
              {/* Diksha Sharma - Co-founder & COO */}
              <div className="space-y-8">
                {/* Profile Image */}
                <div className="flex justify-center">
                  <div className="relative">
                    {/* Decorative background */}
                    <div className="absolute inset-0 w-80 h-80 bg-gradient-to-br from-primary/15 to-primary/5 rounded-full" />
                    <div className="absolute top-4 left-4 w-72 h-72 border-2 border-primary/15 rounded-full animate-spin" style={{ animationDuration: "25s", animationDirection: "reverse" }} />
                    ...
                    {/* Floating elements */}
                    <div className="absolute top-16 left-8 w-3 h-3 bg-primary/30 rounded-full animate-pulse" style={{ animationDelay: "0.5s" }} />
                    <div className="absolute bottom-12 right-4 w-4 h-4 bg-primary/40 rounded-full animate-ping" style={{ animationDelay: "2s" }} />
                  </div>
                </div>
                ...
                <div className="text-center space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground font-inter leading-relaxed max-w-md mx-auto">
                    Diksha Sharma is the Co-founder and Chief Operating Officer of NAMESPACE, bringing strategic vision and operational excellence to the organization. She plays a key role in scaling NAMESPACE's impact across communities and partnerships, ensuring the ecosystem runs smoothly while maintaining its human-centered mission.
                  </p>
